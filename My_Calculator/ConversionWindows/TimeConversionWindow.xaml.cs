...
{
    /// <summary>
    /// Interaction logic for TimeConversionWindow.xaml
    /// </summary>
    public partial class TimeConversionWindow : Window
    {
        ...
        private void CalculateConversion()
        {
            if (IsLoaded && UnitComboBox.SelectedItem is ComboBoxItem item)
            {
                ...
                {
                    string currentTimeTypeString = item.Tag as string;
                    try
                    {
                        TimeTypeEnum currentTimeType = (TimeTypeEnum)Enum.Parse(typeof(TimeTypeEnum), currentTimeTypeString, true);
                        TimeConversion.SetValueToConvert(currentValue, currentTimeType);
                        SecondsCell.Content = TimeConversion.Seconds;
                        MinutesCell.Content = TimeConversion.Minutes;
                        HoursCell.Content = TimeConversion.Hours;
                    }
